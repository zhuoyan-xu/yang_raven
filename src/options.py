...
class Options:
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument(
            ...
            default=0,
            type=int,
            help="Number of in-context examples for each encoder (FICL). Use standard in-context learning when fusion=0",
        )
    ...
    def add_modeling_options(self):
        ...
        self.parser.add_argument(
            "--contexts",
            nargs="+",
            help="list of paths to jsonl files containing contexts to index and retrieve from. Unused if loading a saved index using --load_index_path_data_retrieval",
        )
        self.parser.add_argument(
            "--max_passages",
            type=int,
        ...
        self.parser.add_argument(
            "--use_file_contexts",
            action="store_true",
            help='uses contexts in "contexts" field in train or eval jsonl files rather than retrieving contexts',
        )
        self.parser.add_argument(
            "--retriever_n_context",
            type=int,
        ...
        # Generation options
        self.parser.add_argument("--generation_max_length", type=int, default=512)
        self.parser.add_argument("--generation_min_length", type=int, default=3)
        ...
        self.parser.add_argument(
            ...
            type=str,
            default=None,
            choices=["base", "mlm", "lm", "multiple_choice", "qa"],
        ...
        self.parser.add_argument(
            "--mlm_suffix_noise_density",
            type=float,
            default=0.1,
            help="how much of the suffix should be masked by masking span (for training RAVEN) ",
        )
        self.parser.add_argument(
    ...
    def add_index_options(self):
        ...
        self.parser.add_argument(
            "--load_index_path_data_retrieval",
            default=None,
            type=str,
            help="path for loading the in-context example retrieval index, passage embeddings and passages",
        )
        self.parser.add_argument(
            "--save_index_path",
            default=None,
        ...
        self.parser.add_argument(
            "--save_index_path_data_retrieval",
            default=None,
            type=str,
            help="path for saving the index and/or embeddings",
        )
