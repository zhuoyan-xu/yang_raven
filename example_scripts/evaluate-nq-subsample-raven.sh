...
PRETRAINED_INDEX=${DATA_DIR}/indices/wiki-mlm-${size}-raven-org-enwiki-dec2018-sub${SUBSAMPLE}/passages
PRETRAINED_INDEX2=${DATA_DIR}/indices/wiki-mlm-${size}-raven-org-enwiki-dec2018-sub${SUBSAMPLE}/contexts
...
CMD="python ${SHARE_OUTPUT}/evaluate.py \
    ...
    --save_index_path_data_retrieval ${PRETRAINED_INDEX2} \
    --passages ${PASSAGES} \
    --contexts ${CONTEXTS}
    "
